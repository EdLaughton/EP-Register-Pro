...
assert(/Year 18/.test(hooks.renderOverviewRenewalsCard({ renewal: unitaryRenewal, federated: { renewalFeesPaidUntil: 'Year 17', status: '', upMemberStates: '', invalidationDate: '' }, stage: 'Granted', status: 'Unitary effect registered' })), 'Renewal card should render the next unitary renewal from the federated paid-through horizon rather than a stale earlier legal-renewal year');
