...
function buildActionableOverviewState({ mainSourceStatus = '', statusSummary = null, posture = null, deadlines = [], waitingOn = '', waitingDays = null, latestApplicant = null } = {}) {
  return {
    ...
    nextDeadline: selectNextDeadline(deadlines, !!posture?.currentClosed),
